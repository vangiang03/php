...
$sql="INSERT INTO `$table` (`name`,`img`,`description`,`content`) 
...
<table class="table">
  ...
  while($row=mysqli_fetch_assoc($result))
  {
      ...
      <td><a href='index.php?cmd=".$cmd."&action=copy&id=".$row['id']."' class='btn btn-danger'><i class='fas fa-trash'></i></a></td>
      ". $tatus ."
    </tr> ";
  }
  ?> </tbody>
